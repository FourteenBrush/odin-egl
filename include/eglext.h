...
/* TODO: remove this include, this is only used by bindgen because libclang cannot find definitions from egl.h */
/* resolve when https://github.com/karl-zylinski/odin-c-bindgen/issues/103 if resolved */
#include "egl.h"
